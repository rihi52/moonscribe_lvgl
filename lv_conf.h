 ...
 *  @endcode
 */
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE(Metamorphous_12)    LV_FONT_DECLARE(Metamorphous_16)   LV_FONT_DECLARE(Metamorphous_24)    LV_FONT_DECLARE(CinzelDecorativeBold_48)
